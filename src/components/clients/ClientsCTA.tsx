...
const ClientsCTA = () => {
  return (
    <section className="relative py-20 md:py-28 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-[#22bccb]/3 to-white pointer-events-none" />

      <div className="container-glamlink px-5 md:px-8 relative z-10">
        <div className="relative rounded-3xl bg-white/70 backdrop-blur-xl border border-gray-100/80 shadow-2xl shadow-[#22bccb]/10 p-8 md:p-12 lg:p-16 overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-[0.04]">
            <svg className="w-full h-full" viewBox="0 0 800 800">
              <defs>
                ...
                >
                  <circle cx="30" cy="30" r="1.5" fill="#22bccb" />
                </pattern>
              </defs>
          ...
          <div className="absolute -top-32 -right-32 w-[500px] h-[500px] bg-[#22bccb]/8 rounded-full blur-3xl animate-pulse-slow" />
          <div className="absolute -bottom-32 -left-32 w-[400px] h-[400px] bg-[#22bccb]/6 rounded-full blur-3xl animate-pulse-slow delay-1000" />
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5 md:gap-6">
              <Button
                size="lg"
                className="group min-w-[240px] bg-[#22bccb] hover:bg-[#1ea8b5] text-white font-semibold text-base md:text-lg rounded-full shadow-xl shadow-[#22bccb]/25 hover:shadow-2xl hover:shadow-[#22bccb]/35 transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] flex items-center gap-3 px-8 md:px-10 py-6 md:py-7"
              >
                Create Free Account
