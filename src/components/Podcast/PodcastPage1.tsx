...
const SPOTIFY_URL =
  "https://open.spotify.com/show/0GEWcvRT3PFalAaN2faX4z?si=OWqOPcyZSZqNn7ATTnGJng";
        ...
        {video.thumbnail ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-[hsl(204_18%_94%)]">
            <span
              ...
              style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", color: "hsl(184 40% 70%)" }}
            >
              {episodeNum}
            </span>
          </div>
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto">
        <div className="flex items-baseline justify-between mb-12">
          <div>
            ...
            <h2 className="text-[28px] font-semibold" style={{ color: "hsl(210 30% 10%)" }}>
              Latest Episodes
            </h2>
          </div>
          <p
...
<NotifySection/>
      {/* ── About Strip ──────────────────────────────────────────────────── */}
      <section className="py-16 px-6" style={{ background: "hsl(204 18% 89%)" }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[18px] leading-relaxed font-normal" style={{ color: "hsl(210 25% 22%)" }}>
          ...
          <div className="mt-8 flex items-center justify-center gap-8 text-center">
            <div>
              <p className="text-3xl font-semibold" style={{ color: "hsl(210 30% 10%)" }}>
                {episodeCount}+
              </p>
              <p className="text-[10px] tracking-widest uppercase mt-1" style={{ color: "hsl(210 12% 52%)" }}>
                Episodes
              </p>
            </div>
            <div className="w-px h-10" style={{ background: "hsl(204 14% 80%)" }} />
          </div>
        </div>
      </section>
