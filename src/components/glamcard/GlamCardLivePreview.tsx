...
const handleCopyLink = async () => {
  ...
  >
    <Download size={18} strokeWidth={2.5} />
                        ...
                        <div className="mt-3 flex gap-2 overflow-x-auto p-3">
                          {otherIndexes.slice(0, 4).map((index) => (
                            <button
                              ...
                              className={`relative h-14 w-14 overflow-hidden rounded-lg border shadow-sm flex-shrink-0 ${thumbnailIndex === index
            ...
            {/* ===== SOCIAL ICONS ===== */}
            <div className="flex justify-end flex-wrap gap-3 mt-3">
              {data?.website && (
              ...
              {socialMedia?.facebook && (
                <a href={socialMedia.facebook} target="_blank" rel="noopener noreferrer" title={socialMedia.facebook}>
                  <Facebook className="w-4 h-4 text-gray-500 hover:text-blue-600 transition" />
                </a>
              )}
              {socialMedia?.linkedin && (
                <a href={socialMedia.linkedin} target="_blank" rel="noopener noreferrer" title={socialMedia.linkedin}>
                  <Linkedin className="w-4 h-4 text-gray-500 hover:text-blue-700 transition" />
                </a>
              )}
              {socialMedia?.youtube && (
                <a href={socialMedia.youtube} target="_blank" rel="noopener noreferrer" title={socialMedia.youtube}>
                  <Youtube className="w-4 h-4 text-gray-500 hover:text-red-600 transition" />
                </a>
              )}
              {socialMedia?.tiktok && (
                <a href={socialMedia.tiktok} target="_blank" rel="noopener noreferrer" title={socialMedia.tiktok}>
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                ...
                className={`flex items-center gap-3 p-4 rounded-xl border transition-colors ${data.booking_link
              ...
              <a
                ...
                className={`flex items-center gap-3 p-4 rounded-xl border transition-colors ${data.phone
                    ? "border-gray-200 hover:bg-gray-50"
                    : "border-gray-200 opacity-50 cursor-not-allowed"
                  }`}
              >
              ...
              {/* INSTAGRAM DM — one row per handle */}
