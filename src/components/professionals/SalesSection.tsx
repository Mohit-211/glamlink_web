import { Play, ShoppingBag, Video, Layers, Wrench, TrendingUp, Users, DollarSign, Globe } from 'lucide-react';

const benefits = [
  {
    icon: Globe,
    title: 'Run Your Shop Everywhere',
    description: 'Your products appear across all Glamlink surfaces — discovery, profiles, content, and more.',
    metric: '10x',
  ...
  },
  {
    ...
    description: 'Link products directly to your clips, galleries, and posts. Content that converts.',
    metric: '47%',
  ...
  },
  {
    ...
    description: 'Booking, products, payments, and messaging — all in one seamless platform.',
    metric: '1',
  ...
  },
  {
    ...
    description: 'Analytics, inventory, promotions, and customer insights designed for beauty pros.',
    metric: '24/7',
      ...
      <div className="container-glamlink">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Glamlink isn't just a directory — it's a complete business platform designed to maximize your income.
          </p>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto mb-16">
          <div className="aspect-video rounded-3xl bg-gradient-to-br from-secondary via-secondary/50 to-primary/10 border border-border overflow-hidden relative group cursor-pointer">
            ...
            <div className="absolute top-6 left-6">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background/90 backdrop-blur-sm text-foreground text-sm font-medium border border-border">
            ...
            <div className="absolute bottom-6 right-6 flex gap-2">
              {[1, 2, 3].map((i) => (
                <div key={i} className="w-16 h-12 rounded-lg bg-background/20 backdrop-blur-sm border border-white/10" />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-card rounded-2xl p-6 border border-border hover:border-primary/30 transition-all group hover:-translate-y-1">
