    ...
    <div className="transition-all duration-200">
      <div className="relative flex items-start">
        ...
        <div className="ml-3 text-sm">
          <label
            htmlFor={fieldKey}
            className={`font-normal text-gray-700 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 ${
              error ? 'text-red-700' : ''
            }`}
          >
            <span dangerouslySetInnerHTML={{ __html: config.label }} />
