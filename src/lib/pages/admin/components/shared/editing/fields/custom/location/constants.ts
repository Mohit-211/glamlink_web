/**
 * US States constants for location selection
 */

export interface StateOption {
  value: string;  // State abbreviation (e.g., "CA")
  label: string;  // Full state name (e.g., "California")
}
...
export function getStateAbbreviation(name: string): string {
  const state = US_STATES.find(s => s.label.toLowerCase() === name.toLowerCase());
