    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{" "}
          <Link href={loginUrl} className="font-medium text-glamlink-teal hover:text-glamlink-teal-dark">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="newsletterSubscribed" className="font-medium text-gray-700">
                  Subscribe to newsletter
                </label>
                <p className="text-gray-500">Get weekly beauty insights and magazine updates</p>
              </div>
            </div>
