...
import { isWhyGlamlinkSection } from '@/lib/pages/admin/components/content-settings/content/sections/home/types';

interface WhyGlamlinkSectionProps {
  section: HomeSection;
}
...
export function WhyGlamlinkSection({ section }: WhyGlamlinkSectionProps) {
  if (!isWhyGlamlinkSection(section)) return null;
    ...
    <section className="pt-8 pb-8 bg-white">
      <div className="container-custom">
        <div className="grid lg-custom:grid-cols-2 gap-8">
          ...
          <div
            className="card-selected rounded-lg p-8"
            style={{ backgroundColor: "#faffff", border: "3px solid #c4e2e6" }}
          >
          ...
          <div className="rounded-lg shadow-md p-8" style={{ border: "1px solid #f7f7f7" }}>
            <h3 className="text-3xl font-medium text-gray-900 mb-2">
              {content.proCard?.title || 'For Professionals'}
            </h3>
            <p className="text-gray-600 mb-6">
              {content.proCard?.subtitle || 'Get discovered, get booked, and unlock new ways to grow.'}
            </p>

            <ul className="space-y-4">
              {content.proCard?.features && content.proCard.features.length > 0 ? (
                content.proCard.features.map((feature, index) => {
                  const IconComponent = iconMap[feature.icon || ''] || null;
                  return (
                    <li key={index} className="flex items-start gap-3">
                      {IconComponent ? (
                ...
                // Fallback to hardcoded defaults if no proCard features
                <>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Be found by what you do best. Whether it's lashes, microblading, brows, we'll help connect you to clients actively searching for your exact services.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Fill your calendar with real bookings. Our smart tools help you manage clients, stay organized, and grow your business seamlessly.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        From selling your favorite products to launching your own brand or app, it's possible.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        AI-powered features are helping you do more with the right clients.
                      </p>
                    </div>
                  </li>
                </>
